<?php
    ...
    {
        $roundId = createRound(intval($_POST['tournamentId']), $_POST['roundName'], 
    ...
    else if (isset($_POST['createRound']))
    {
        $answer = createRoundErr(intval($_POST['tournamentId']), $_POST['roundName'], 
                    intval($_POST['checker']), intval($_POST['previousRound']), intval($_POST['seed']));
