<?php
    ...
    if (isAdmin())
    {
        ...
        if (mysqli_select_db($link, getDBName()))
        {
            ...
            foreach ($ids as $id)
                mysqli_query($link, "INSERT INTO scores SET round = $roundId, strategy = " . intval($id) . ", score = 0");
            ...
            foreach ($ids as $id1)
            {
                ...
                {
                    if ($id1 != $id2)
                        mysqli_query($link, "INSERT INTO duels SET round = $roundId, "
                            ."strategy1 = ".intval($id1).", strategy2 = ".intval($id2).", status = 'W'");
                }
            }
